...
-- 插入测试数据
-- 插入测试用户
INSERT INTO `users` (`openid`, `phone`, `name`, `nickname`, `user_type`, `city`, `province`) VALUES
('test_openid_001', '13800138001', '张三', '张三', 'user', '北京市', '北京市'),
('test_openid_002', '13800138002', '李四', '李四', 'electrician', '北京市', '北京市'),
('test_openid_003', '13800138003', '王五', '王五', 'electrician', '上海市', '上海市'),
('test_openid_004', '13800138004', '赵六', '赵六', 'user', '广州市', '广东省'),
('test_openid_005', '13800138005', '管理员', '管理员', 'admin', '北京市', '北京市');

-- 插入测试电工
INSERT INTO `electricians` (`user_id`, `certificate_number`, `certificate_type`, `experience_years`, `specialties`, `service_areas`, `work_status`, `verification_status`, `rating`, `emergency_available`) VALUES
(2, 'CERT001', 'low_voltage', 5, '["家用电路维修", "开关插座安装"]', '["朝阳区", "海淀区"]', 'available', 'approved', 4.8, true),
(3, 'CERT002', 'high_voltage', 8, '["工业电路维修", "配电箱安装"]', '["浦东新区", "黄浦区"]', 'available', 'approved', 4.9, false);

-- 插入测试工单
INSERT INTO `orders` (`order_number`, `user_id`, `electrician_id`, `title`, `description`, `fault_type`, `priority`, `status`, `contact_phone`, `contact_name`, `address`, `estimated_amount`, `payment_status`) VALUES
('ORD20240120001', 1, 2, '客厅灯不亮', '客厅吸顶灯突然不亮了，开关正常', 'lighting', 'medium', 'completed', '13800138001', '张三', '北京市朝阳区建国路1号', 80.00, 'paid'),
('ORD20240120002', 4, NULL, '厨房插座没电', '厨房所有插座都没电，疑似跳闸', 'circuit', 'high', 'pending', '13800138004', '赵六', '广州市天河区天河路100号', 120.00, 'unpaid');

-- 插入测试支付记录
INSERT INTO `payments` (`payment_number`, `order_id`, `user_id`, `electrician_id`, `amount`, `payment_method`, `status`, `transaction_id`, `paid_at`) VALUES
('PAY20240120001', 1, 1, 2, 80.00, 'wechat', 'paid', 'wx_test_001', '2024-01-20 10:30:00');

-- 插入测试评价
INSERT INTO `reviews` (`order_id`, `user_id`, `electrician_id`, `service_rating`, `quality_rating`, `speed_rating`, `overall_rating`, `content`) VALUES
(1, 1, 2, 5, 5, 4, 4.67, '师傅很专业，服务态度好，问题解决得很快');
